...
interface Bank { name: string; bank_name?: string | null; account_number?: string | null; account_holder?: string | null }
          ...
          {(banks ?? []).map((b, i) => (
            <div key={i} className="flex items-center justify-between rounded-lg bg-sand/50 px-3 py-2">
              <div>
                ...
                <div className="text-xs text-ink/50">a/n {b.account_holder || b.name}</div>
              </div>
